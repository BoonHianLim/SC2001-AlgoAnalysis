...
int main()
{
    ...
    for(int total_run = 0; total_run < 100; total_run++){
        ...
        //printf(str);
        char file1[100] = "C:\\Users\\USER\\Documents\\Github\\Algo_Analysis_Performance\\Data\\BestCaseN\\MergeCount";
        strcat(file1,str11);
        strcat(file1,str12);
        ...
        char file2[100] = "C:\\Users\\USER\\Documents\\Github\\Algo_Analysis_Performance\\Data\\BestCaseN\\MergeDelay";
        strcat(file2,str21);
        strcat(file2,str22);
        ...
        char file3[100] = "C:\\Users\\USER\\Documents\\Github\\Algo_Analysis_Performance\\Data\\BestCaseN\\MergeHybridCount";
        strcat(file3,str31);
        strcat(file3,str32);
        ...
        char file4[100] = "C:\\Users\\USER\\Documents\\Github\\Algo_Analysis_Performance\\Data\\BestCaseN\\MergeHybridDelay";
        strcat(file4,str41);
        strcat(file4,str42);
