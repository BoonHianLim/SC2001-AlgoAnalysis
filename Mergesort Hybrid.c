...
int main()
{
    ...
    for(int total_run = 0; total_run < 1; total_run++){
        ...
        //printf(str);
        char file1[] = "C:\\Users\\USER\\Documents\\Github\\Algo_Analysis_Performance\\Data\\MergeCount";
        strcat(file1,str11);
        strcat(file1,str12);
        ...
        char file2[] = "C:\\Users\\USER\\Documents\\Github\\Algo_Analysis_Performance\\Data\\MergeDelay";
        strcat(file2,str21);
        strcat(file2,str22);
        ...
        char file3[] = "C:\\Users\\USER\\Documents\\Github\\Algo_Analysis_Performance\\Data\\MergeHybridCount";
        strcat(file3,str31);
        strcat(file3,str32);
        ...
        char str42[] = ".txt";
        printf(file3);
        char file4[] = "C:\\Users\\USER\\Documents\\Github\\Algo_Analysis_Performance\\Data\\MergeHybridDelay";
        printf(file3);
        strcat(file4,str41);
